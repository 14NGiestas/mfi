...
block
 ...
 call test_slamch 
    ...
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [31ms[0m mfi_lamch ([34mCPU[0m) against [31mslamch[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
block
    integer :: t_n, t_i, t_stat
    real :: t_t1, t_t2, t_sum, t_sum2, t_tmin, t_tmax, t_sig
 ...
 call test_dlamch 
    ...
    call fmt_time(t_tmax, t_mx)
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [32md[0m mfi_lamch ([34mCPU[0m) against [32mdlamch[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
  contains
