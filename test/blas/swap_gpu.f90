 ...
 use mfi_blas
 implicit none
 print '(A)', "testing mfi_swap (GPU) against sswap"
 print '(A)', "testing mfi_swap (GPU) against dswap"
 print '(A)', "testing mfi_swap (GPU) against cswap"
 print '(A)', "testing mfi_swap (GPU) against zswap"
 contains
