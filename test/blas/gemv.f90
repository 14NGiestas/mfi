...
block
 ...
 call test_sgemv 
    ...
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [31ms[0m mfi_gemv ([34mCPU[0m) against [31msgemv[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
block
    integer :: t_n, t_i, t_stat
    real :: t_t1, t_t2, t_sum, t_sum2, t_tmin, t_tmax, t_sig
 ...
 call test_dgemv 
    ...
    call fmt_time(t_tmax, t_mx)
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [32md[0m mfi_gemv ([34mCPU[0m) against [32mdgemv[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
block
    integer :: t_n, t_i, t_stat
    real :: t_t1, t_t2, t_sum, t_sum2, t_tmin, t_tmax, t_sig
 ...
 call test_cgemv 
    ...
    call fmt_time(t_tmax, t_mx)
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [34mc[0m mfi_gemv ([34mCPU[0m) against [34mcgemv[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
block
    integer :: t_n, t_i, t_stat
    real :: t_t1, t_t2, t_sum, t_sum2, t_tmin, t_tmax, t_sig
 ...
 call test_zgemv 
    ...
    call fmt_time(t_tmax, t_mx)
    print '(A,"  μ=",A16," σ=",A16," min=",A16," max=",A16,"  (",I0," runs)")', &
        "testing [33mz[0m mfi_gemv ([34mCPU[0m) against [33mzgemv[0m", t_mu, t_ms, t_mn, t_mx, t_n
end block
  contains
...
subroutine test_sgemv
    ...
    use mfi_blas, only: mfi_gemv, mfi_sgemv, mfi_force_gpu, mfi_force_cpu
...
subroutine test_dgemv
    ...
    use mfi_blas, only: mfi_gemv, mfi_dgemv, mfi_force_gpu, mfi_force_cpu
...
subroutine test_cgemv
    ...
    use mfi_blas, only: mfi_gemv, mfi_cgemv, mfi_force_gpu, mfi_force_cpu
...
subroutine test_zgemv
    ...
    use mfi_blas, only: mfi_gemv, mfi_zgemv, mfi_force_gpu, mfi_force_cpu
