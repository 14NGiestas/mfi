 ...
 use mfi_blas
 implicit none
 print '(A)', "testing mfi_axpy (GPU) against saxpy"
 print '(A)', "testing mfi_axpy (GPU) against daxpy"
 print '(A)', "testing mfi_axpy (GPU) against caxpy"
 print '(A)', "testing mfi_axpy (GPU) against zaxpy"
 contains
