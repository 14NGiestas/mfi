 ...
 implicit none
 print '(A)', "testing mfi_gesvd (CPU) against sgesvd"
 print '(A)', "testing mfi_gesvd (CPU) against dgesvd"
 print '(A)', "testing mfi_gesvd (CPU) against cgesvd"
 print '(A)', "testing mfi_gesvd (CPU) against zgesvd"
 contains
