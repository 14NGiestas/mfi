 ...
 implicit none
 print '(A)', "testing mfi_geqrf (CPU) against sgeqrf"
 print '(A)', "testing mfi_geqrf (CPU) against dgeqrf"
 print '(A)', "testing mfi_geqrf (CPU) against cgeqrf"
 print '(A)', "testing mfi_geqrf (CPU) against zgeqrf"
 contains
