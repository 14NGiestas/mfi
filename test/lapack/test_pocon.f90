 ...
 implicit none
 print '(A)', "testing mfi_pocon (CPU) against spocon"
 print '(A)', "testing mfi_pocon (CPU) against dpocon"
 print '(A)', "testing mfi_pocon (CPU) against cpocon"
 print '(A)', "testing mfi_pocon (CPU) against zpocon"
 contains
