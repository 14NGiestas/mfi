...
call cpu_time(t1)
 call test_sgetrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getrs (CPU) against sgetrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_dgetrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getrs (CPU) against dgetrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_cgetrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getrs (CPU) against cgetrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_zgetrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getrs (CPU) against zgetrs", t2-t1
end block
contains
