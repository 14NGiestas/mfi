 ...
 implicit none
 print '(A)', "testing mfi_trtrs (GPU) against strtrs"
 print '(A)', "testing mfi_trtrs (GPU) against dtrtrs"
 print '(A)', "testing mfi_trtrs (GPU) against ctrtrs"
 print '(A)', "testing mfi_trtrs (GPU) against ztrtrs"
 contains
