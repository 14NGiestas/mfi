 ...
 implicit none
 print '(A)', "testing mfi_potrf (GPU) against spotrf"
 print '(A)', "testing mfi_potrf (GPU) against dpotrf"
 print '(A)', "testing mfi_potrf (GPU) against cpotrf"
 print '(A)', "testing mfi_potrf (GPU) against zpotrf"
 contains
