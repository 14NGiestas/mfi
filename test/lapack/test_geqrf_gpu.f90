 ...
 implicit none
 print '(A)', "testing mfi_geqrf (GPU) against sgeqrf"
 print '(A)', "testing mfi_geqrf (GPU) against dgeqrf"
 print '(A)', "testing mfi_geqrf (GPU) against cgeqrf"
 print '(A)', "testing mfi_geqrf (GPU) against zgeqrf"
 contains
