...
call cpu_time(t1)
 call test_strtrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_trtrs (CPU) against strtrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_dtrtrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_trtrs (CPU) against dtrtrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_ctrtrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_trtrs (CPU) against ctrtrs", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_ztrtrs 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_trtrs (CPU) against ztrtrs", t2-t1
end block
contains
