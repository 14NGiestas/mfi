 ...
 implicit none
 print '(A)', "testing mfi_getrf (GPU) against sgetrf"
 print '(A)', "testing mfi_getrf (GPU) against dgetrf"
 print '(A)', "testing mfi_getrf (GPU) against cgetrf"
 print '(A)', "testing mfi_getrf (GPU) against zgetrf"
 contains
