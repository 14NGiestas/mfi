 ...
 implicit none
 print '(A)', "testing mfi_getrs (GPU) against sgetrs"
 print '(A)', "testing mfi_getrs (GPU) against dgetrs"
 print '(A)', "testing mfi_getrs (GPU) against cgetrs"
 print '(A)', "testing mfi_getrs (GPU) against zgetrs"
 contains
