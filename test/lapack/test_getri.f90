 ...
 implicit none
 print '(A)', "testing mfi_getri (CPU) against sgetri"
 print '(A)', "testing mfi_getri (CPU) against dgetri"
 print '(A)', "testing mfi_getri (CPU) against cgetri"
 print '(A)', "testing mfi_getri (CPU) against zgetri"
 contains
