 ...
 implicit none
 print '(A)', "testing mfi_trtrs (CPU) against strtrs"
 print '(A)', "testing mfi_trtrs (CPU) against dtrtrs"
 print '(A)', "testing mfi_trtrs (CPU) against ctrtrs"
 print '(A)', "testing mfi_trtrs (CPU) against ztrtrs"
 contains
