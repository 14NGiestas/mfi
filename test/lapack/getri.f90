...
call cpu_time(t1)
 call test_sgetri 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getri (CPU) against sgetri", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_dgetri 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getri (CPU) against dgetri", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_cgetri 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getri (CPU) against cgetri", t2-t1
end block
block
real :: t1, t2
call cpu_time(t1)
 call test_zgetri 
call cpu_time(t2)
print '(A," (",G0,"s)")', "testing mfi_getri (CPU) against zgetri", t2-t1
end block
contains
