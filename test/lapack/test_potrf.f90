 ...
 implicit none
 print '(A)', "testing mfi_potrf (CPU) against spotrf"
 print '(A)', "testing mfi_potrf (CPU) against dpotrf"
 print '(A)', "testing mfi_potrf (CPU) against cpotrf"
 print '(A)', "testing mfi_potrf (CPU) against zpotrf"
 contains
