...
! sgemm GPU (cublas) version
pure subroutine cublasSgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    ...
    real(wp),value, intent(in) :: alpha
    real(wp),value, intent(in) :: beta
...
! dgemm GPU (cublas) version
pure subroutine cublasDgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
...
! cgemm GPU (cublas) version
pure subroutine cublasCgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    ...
    character(c_char),value, intent(in) :: transa
    character(c_char),value, intent(in) :: transb
    complex(wp),value, intent(in) :: alpha
    complex(wp),value, intent(in) :: beta
    integer(c_int),value, intent(in) :: m
    integer(c_int),value, intent(in) :: n
    integer(c_int),value, intent(in) :: k
    integer(c_int),value, intent(in) :: lda
...
! zgemm GPU (cublas) version
pure subroutine cublasZgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
...
! chemm GPU (cublas) version
pure subroutine cublasChemm(side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc) &
    ...
    type(c_ptr), value, intent(in) :: b
    type(c_ptr), value :: c ! void *
    character(c_char),value, intent(in) :: side
    character(c_char),value, intent(in) :: uplo
    complex(wp),value, intent(in) :: alpha
    complex(wp),value, intent(in) :: beta
    integer(c_int),value, intent(in) :: m
    integer(c_int),value, intent(in) :: n
...
! zhemm GPU (cublas) version
pure subroutine cublasZhemm(side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc) &
...
! ssymm GPU (cublas) version
pure subroutine cublasSsymm(side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc) &
...
! dsymm GPU (cublas) version
pure subroutine cublasDsymm(side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc) &
