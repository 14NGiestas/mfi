...
pure subroutine cublas_sgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    bind(C,name="cublasSgemm")
    import :: REAL32, c_ptr, c_int, c_char
    type(c_ptr), value :: a
    type(c_ptr), value :: b
    type(c_ptr), value :: c
...
pure subroutine cublas_dgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    bind(C,name="cublasDgemm")
    import :: REAL64, c_ptr, c_int, c_char
    type(c_ptr), value :: a
    type(c_ptr), value :: b
    type(c_ptr), value :: c
    character(c_char), intent(in) :: transa
...
pure subroutine cublas_cgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    bind(C,name="cublasCgemm")
    import :: REAL32, c_ptr, c_int, c_char
    type(c_ptr), value :: a
    type(c_ptr), value :: b
...
pure subroutine cublas_zgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
    bind(C,name="cublasZgemm")
    import :: REAL64, c_ptr, c_int, c_char
    type(c_ptr), value :: a
    type(c_ptr), value :: b
